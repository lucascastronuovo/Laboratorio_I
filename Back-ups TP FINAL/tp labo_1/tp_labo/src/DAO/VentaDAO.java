...
public class VentaDAO implements IVentaDAO{
    ...
    public void registrarVenta(Venta venta) throws DAOException {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("INSERT INTO ventas_(ID, EVENTO,DNI_CLIENTE,NOMBRE_CLIENTE, APELLIDO_CLIENTE, FECHA, TOTAL_PAGADO ,ZONA, VENDEDOR, IDEVENTO, CANTIDAD_ENTRADAS) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
    ...
    public ArrayList traerVentas(int idEvento) throws ServiceException, DAOException {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("SELECT * FROM VENTAS_ WHERE IDEVENTO = ?");
    ...
    public int calcularTotalVendido(int idEvento, String fechaDesde, String fechaHasta) throws DAOException, ServiceException {
        ...
        try {
            ...
            connection = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            //2 crear sentencia SQL
            preparedStatement = connection.prepareStatement("SELECT SUM(TOTAL_PAGADO) FROM VENTAS_ WHERE IDEVENTO = ? AND FECHA BETWEEN ? AND ?");
            preparedStatement.setInt(1,idEvento);
    ...
    public ArrayList traerTodo() throws ServiceException, DAOException {
        ...
        try {
            ...
            connection = DriverManager.getConnection(DB_URL,DB_USER,DB_PASSWORD);
            //2 crear sentencia SQL
            preparedStatement = connection.prepareStatement("SELECT * FROM VENTAS_");
